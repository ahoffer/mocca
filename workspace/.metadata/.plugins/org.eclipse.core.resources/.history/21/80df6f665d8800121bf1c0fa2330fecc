...
public class Mocca extends SubspaceClusterer 
	...
	private double mu_0        = 1000000;  // minimum cluster quality
	...
	public void buildSubspaceClusterer(Instances data) throws Exception {
		...
		SepcWrapper s = new SepcWrapper(alpha, beta, epsilon, mu_0, numClusters, w, maxOverlap, 
